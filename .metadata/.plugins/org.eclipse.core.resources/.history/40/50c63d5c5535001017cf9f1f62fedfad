...
public class UserController {
	...
	@GetMapping("/register")
	public String register(@ModelAttribute UserBean userBean) {
	...
	public String doRegister(@Valid @ModelAttribute() UserBean userBean, BindingResult result, Model model) {
		if (result.hasErrors()) {
			return "user/register";
		}
		...
		if (findUser == null) {
			...
			//			model.addAttribute("email", "メールが存在します。");
			return "user/register";
		}
	}
