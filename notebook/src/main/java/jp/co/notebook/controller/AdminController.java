...
import jp.co.notebook.bean.CreateUserBean;
...
public class AdminController {
	...
	public String doCreateUser(CreateUserBean userBean) {
		User user = new User();
		BeanUtils.copyProperties(userBean, user);
		user.setRole(this.roleService.handleFindRoleById(userBean.getRole()));
